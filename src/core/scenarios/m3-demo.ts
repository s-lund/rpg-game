...
export const M3_DEMO_GRAPH: WorldGraph = {
  id: "m3_demo",
  sites: [
    { id: "site_cinder_gate", label: "The Cinder Gate", tier: 1, mapX: 22, mapY: 72 },
    { id: "site_drowned_market", label: "Drowned Market", tier: 2, mapX: 38, mapY: 52 },
    { id: "site_ash_foundry", label: "Ash Foundry", tier: 2, mapX: 62, mapY: 48 },
    { id: "site_bell_tower_ruins", label: "Bell Tower Ruins", tier: 3, mapX: 50, mapY: 18 },
  ],
  edges: [
